...
def build_meta_prompt(what, location, sensitivity):
    parts = [
        ...
        "## Buyer Profile\n\n",
        "- Location: " + location + "\n",
        "- Demographic: 47-year-old male, wife, 3 sons, family household, suburban Los Angeles area\n",
        "- Climate context: mild Southern California weather; access to beaches and mountains\n",
        "- Family context: products that affect durability, repairability, and safety matter more\n",
